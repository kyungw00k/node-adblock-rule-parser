...
const SelectorFilter = require('./filter').SelectorFilter
const PatternFilter = require('./filter').PatternFilter
const ElementTypes = require('./element-types')
const getUnicodeDomain = require('../get-unicode-domain');
const logging = require('../logging')(true);
const storage_get = require('../storage').get
const storage_set = require('../storage').set
...
const FilterNormalizer = {
  ...
  normalizeLine: function(filter) {
    ...
    if (typeof FilterNormalizer.userExcludedFilterArray !== 'undefined' &&
        ...
        FilterNormalizer.userExcludedFilterArray.indexOf(filter) >= 0) {
            return null;
    }
    ...
    if (Filter.isSelectorFilter(filter)) {
      ...
      try {
        ...
        //// FIXME: NOT WORKING IN SERVER SIDE
...
module.exports = FilterNormalizer;
